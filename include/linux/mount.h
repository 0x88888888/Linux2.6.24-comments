...
struct vfsmount {
	...
	struct dentry *mnt_mountpoint;	/* 当前文件系统的装载点在其父目录中的dentry结构,dentry of mountpoint */
	struct dentry *mnt_root;	/* 当前文件系统根目录, root of the mounted tree */
	...
	struct mnt_namespace *mnt_ns;	/* 所属的名称空间，containing namespace */
	/*
