 ...
 *  在bootmem allocator的bitmap中标记为已近使用
 */
...
unsigned long __init init_bootmem(unsigned long start, unsigned long pages)
{
	max_low_pfn = pages;
	min_low_pfn = start;
	/* start作为bootmem_allocator 的bitmap起始位置 */
 ...
 *     reserve_bootmem()
 *
 *  在bootmem allocator 中的bitmap设置已经被使用标记
 */
