...
#define RX_FRAME_PORT	0x0000        /* 数据接收缓冲端口地址 */
#define TX_FRAME_PORT RX_FRAME_PORT   /* 数据发送缓冲端口地址 */
#define TX_CMD_PORT	0x0004            /* 数据包发送命令端口地址 */

#define TX_NOW		0x0000            /*  Tx packet after   5 bytes copied */
#define TX_AFTER_381	0x0040       /*  Tx packet after 381 bytes copied */
#define TX_AFTER_ALL	0x00c0       /*  Tx packet after all bytes copied */
#define TX_LEN_PORT	0x0006            /* 数据包长度端口地址 */
#define ISQ_PORT	0x0008            /* 中断状态寄存器端口地址 */
#define ADD_PORT	0x000A            /* 地址寄存器端口地址 */
#define DATA_PORT	0x000C            /* 数据寄存器端口地址 */
