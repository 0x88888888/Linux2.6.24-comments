...
/*
 * paging_32_page_fault()  在paging_tmpl.h中
...
/*
 * paging_tmpl.h中的 set_pte_common 
 *  kvm_mmu_lookup_page()
 *
 */
...
/*
 * paging_tmpl_.h 中的paging_32_page_fault
 *  inject_page_fault()
 */
...
int kvm_mmu_load(struct kvm_vcpu *vcpu)
{
	...
	/*
	 * vmx_x86_ops->set_cr3 == vmx_set_cr3
	 * 设置pgd,在vmcs中写GUEST_CR3
	 */
 ...
 *
 * 内存管理结构初始化
 * 分配pte_chain_cache, rmap_desc_cache, mmu_page_header_cache 对象
 */
