 ...
 *
 */
static int vif_add(struct vifctl *vifc, int mrtsock /* 标识当前配置虚拟接口的是否是组播路由守护进程 */ )
{
...
/*
 * 查找dev对应的vif_device在vif_table[]中的索引
 */
