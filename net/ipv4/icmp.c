 ...
 * 
 * 每种类型icmp报文对应一个icmp_control结构，
 * 在内核中定义了一个该结构类型的数组icmp_pointers[NR_ICMP_TYPES + 1]用来管理ICMP报文.
 *
 */
struct icmp_control {
...
void __init icmp_init(struct net_proto_family *ops)
{
	...
	for_each_possible_cpu(i) {
        ...
        /*
         * 初始化单播报文的TTL值为-1,表示从目的的路由缓存项的度量中获取，
         * 默认值为64,初始化pmtudisc为IP_PMTUDISC_DONT，即不执行路径MTU发现
         */
